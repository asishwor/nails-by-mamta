      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-24 px-6 md:px-12 overflow-hidden bg-background">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center relative z-10">
          ...
          >
            ...
            <div className="relative w-full aspect-[4/5] md:aspect-square rounded-[40px] overflow-hidden shadow-2xl border-4 border-white">
              <img
                src="/hero.png"
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4 text-foreground/70">
              ...
              <div className="flex items-center gap-3 hover:text-primary transition-colors cursor-pointer w-fit">
                <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                  <span className="font-bold text-xs">IG</span>
                </div>
                <span>@nailbymamta</span>
              </div>
            </div>
          </div>
          <div>
